...
<form class="flex flex-col items-center w-[70%] m-auto max-w-[600px] mb-7 border-2 border-Old-mauve shadow-lg py-8 pt-10 mt-2 rounded justify-center" action="/login" method="post">
