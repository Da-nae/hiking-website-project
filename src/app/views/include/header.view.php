        ...
        <nav class="border-gray-200 px-4 sm:px-4 py-2.5 bg-Rich-black ">
            ...
            <a href="/" class="flex items-center">
                ...
                <div class="flex items-center md:order-2">
                    ...
                    <a href="/code?=<?= $_SESSION['user']['id']?>"><button type="button" class="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom" id="user-dropdown">
                        <span class="sr-only">Open user menu</span>
                        <img class="w-8 h-8 rounded-full ml-4" src="assets/hiking.png" alt="user photo">
                    </button>
                    </a>
