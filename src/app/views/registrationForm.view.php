...
<form action="/registration" method="post" class="border-2 border-Old-mauve shadow-lg sm:w-[500px] w-[90%] py-8 rounded mt-20 absolute left-1/2 top-1/2 -translate-y-2/4 -translate-x-2/4 flex flex-col items-center justify-center">
